...
export default class ProductForm {
  ...
  constructor (productId) {
    ...
    this.#imageResortHandler = this.handleResortImages.bind(this);
  ...
  createElement() {
    ...
    this.#controls[FieldName.IMAGES] = new ImageList({ onChange: this.#imageUploadHandler, onResort: this.#imageResortHandler });
  ...
  handleResortImages(images) {
    this.#values[FieldName.IMAGES] = images;
  }
